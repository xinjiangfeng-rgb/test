...
public class CheckRandomPasswordServiceClientImpl extends BaseClientServiceImpl implements ICheckRandomPasswordService
{
	public QRY040095Result checkRandomPassword(String phoneNum, String password) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040095";
		...
		try
		{
			...
			if(__ret instanceof QRY040095Result)
			{
				__result = (QRY040095Result)__ret;
			}
			else
			{
				__result = new QRY040095Result();
