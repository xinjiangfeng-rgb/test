...
import com.xwtech.xwecp.service.logic.pojo.MainSubResourceBean;
...
public class QueryMainAndSubCardsInfoNewInvocation extends BaseInvocation implements ILogicalService {
    private String REQUEST_BOSSTELETEXT = "cc_180820";

    @Override
    public BaseServiceInvocationResult executeService(String accessId, ServiceConfig config, List<RequestParameter> params) {
        QRY180820Result result = new QRY180820Result();
        String rspXml = "";
        try {
            ...
            if (resultObj != null && !"".equals(resultObj)) {
                ...
                List<MainSubResourceBean> mainSubResourceBeans = new ArrayList<>();
                for (int i = 0; i < array.size(); i++) {
                    if (array != null) {
                        JSONObject mainSubResourceObj = (JSONObject) array.get(i);
                        MainSubResourceBean mainSubResourceBean = new MainSubResourceBean();
