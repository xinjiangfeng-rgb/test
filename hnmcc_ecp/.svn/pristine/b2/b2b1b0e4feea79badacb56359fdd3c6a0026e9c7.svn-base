...
////		try
////		{
////			List<Map<String,Object>> list = this.getJdbcTemplate().queryForList(sql.toString(),new Object[]{busiNum});
////			if(null == list || list.size() < 1)
////			{
////				return "";
////			}
...
////		String marketName = JSON.parse(this.getCache().get("RESERVE_MARKET_" + marketNum)).toString();
...
////			try
////			{
////				List<Map<String,Object>> list = this.getJdbcTemplate().queryForList(sql.toString(),new Object[]{marketNum});
////				if(null == list || list.size() < 1)
////				{
////					return "";
////				}
...
////				this.getCache().add("RESERVE_MARKET_" + marketNum, JSON.toJSONString(marketName));
////			}catch (Exception e) {
////				e.printStackTrace();
...
////		ReserveOfficeInfo officeInfo = JSON.parseObject(this.getCache().get("RESERVE_" + officeId), ReserveOfficeInfo.class);
...
////			try
////			{
////				List<Map<String,Object>> list = this.getJdbcTemplate().queryForList(sql.toString(),new Object[]{officeId});
////				if(null == list || list.size() < 1)
////				{
////					return null;
////				}
...
////				this.getCache().add("RESERVE_" + officeId, JSON.toJSONString(officeInfo));
////			}catch (Exception e) {
////				e.printStackTrace();
