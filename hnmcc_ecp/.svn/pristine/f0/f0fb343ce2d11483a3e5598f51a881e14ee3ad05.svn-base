...
public class FourgComboServiceImpl extends BaseClientServiceImpl implements IFourgComboService {

	@Override
	public QRY040203Result check4G(String svcNum) throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040203";
		...
		try
		{
			...
			if(__ret instanceof QRY040203Result)
			{
				__result = (QRY040203Result)__ret;
			}
			else
			{
				__result = new QRY040203Result();
