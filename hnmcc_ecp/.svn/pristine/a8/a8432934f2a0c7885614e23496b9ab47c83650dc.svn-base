...
import com.xwtech.xwecp.service.logic.client_impl.common.IQueryAuthStateService;
import com.xwtech.xwecp.service.logic.client_impl.common.impl.QueryAuthStateClientImpl;
...
{
	private static final Logger logger = LoggerFactory.getLogger(QRY040110Test.class);
...
//		props.put("platform.url", "http://112.53.127.41:32812/hnmcc_ecp/xwecp.do");
		...
		IQueryAuthStateService co = new QueryAuthStateClientImpl();
//		QRY010099Result re = co.queryGmisInfo("4475","514442");
//		6402    125810 
		QRY040110Result re = co.queryAuthState("18803695181");
		System.out.println(" ====== 开始返回参数 ======");
		if (re != null)
		{
			System.out.println(" ====== 返回结果码 ======" + re.getResultCode());
			System.out.println(" ====== re.getAuthState() ======" +re.getAuthState());
			System.out.println(" ====== re.getAuthStateName() ======" +re.getAuthStateName());
