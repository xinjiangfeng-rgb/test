...
public class QryVisibleToHandleServiceClientImpl extends BaseClientServiceImpl
		implements IQryVisibleToHandleService {

	public QRY040202Result qryVisibleToHandle(String svcNum,String offerId,String filtMarket,String filtResGoods)
			throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040202";
		...
		try
		{
			...
			if(__ret instanceof QRY040202Result)
			{
				__result = (QRY040202Result)__ret;
			}
			else
			{
				__result = new QRY040202Result();
