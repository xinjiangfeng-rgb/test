...
public class QueryAccountStatementServiceImpl extends BaseClientServiceImpl implements IQueryAccountStatementService {

    @Override
    public QRY420031Result queryAccountStatement(String billId, String billingCycleId) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "QRY420031";
        ...
        try {
            ...
            if (__ret instanceof QRY420031Result) {
                __result = (QRY420031Result) __ret;
            } else {
                __result = new QRY420031Result();
