...
public class QueryScoreExchangeDetailNewServiceImpl extends BaseClientServiceImpl implements IQueryScoreExchangeDetailNewService
{
	public QRY040206Result queryScoreExchangeDetail(String phoneNum, String beginDate, String endDate) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040206";
		...
		try
		{
			...
			if(__ret instanceof QRY040206Result)
			{
				__result = (QRY040206Result)__ret;
			}
			else
			{
				__result = new QRY040206Result();
