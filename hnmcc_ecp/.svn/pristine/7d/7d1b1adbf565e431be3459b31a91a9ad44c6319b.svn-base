...
public class DEL300002Result extends BaseServiceInvocationResult
{
	...
	public String toString() {
		return "DEL300002Result [billInfo=" + billInfo + ", doneCode="
				+ doneCode + ", svcNum=" + svcNum + ", prodPrcName="
				+ prodPrcName + ", confirmFlag=" + confirmFlag + "]";
	}
