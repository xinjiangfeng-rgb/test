...
import com.xwtech.xwecp.service.logic.client_impl.common.IPackageActivitiesService2;
import com.xwtech.xwecp.service.logic.pojo.DEL218920Result;

public class PackageActivitiesServiceImpl2 implements IPackageActivitiesService2 {

    @Override
    public DEL218920Result qryPackageActivities(String billId, String basicoffreid, String ployid, String telephonist) {

        long __beginTime = System.currentTimeMillis();
        String __cmd = "DEL218920";
        ...
        try
        {
            ...
            if(__ret instanceof DEL218920Result)
            {
                __result = (DEL218920Result)__ret;
            }
            else
            {
                __result = new DEL218920Result();
