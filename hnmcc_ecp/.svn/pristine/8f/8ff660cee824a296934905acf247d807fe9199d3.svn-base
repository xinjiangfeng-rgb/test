...
public class QueryClaimForEquityServiceImpl extends BaseClientServiceImpl implements IQueryClaimForEquityService {
    @Override
    public QRY300011Result queryClaimForEquity(Object publics,Object busiInfo) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "QRY300011";
        ...
        try {
            ...
            if (__ret instanceof QRY300011Result) {
                __result = (QRY300011Result) __ret;
            } else {
                __result = new QRY300011Result();
