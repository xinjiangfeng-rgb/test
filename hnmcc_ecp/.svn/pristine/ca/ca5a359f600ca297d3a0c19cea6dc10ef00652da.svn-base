...
import com.xwtech.xwecp.service.logic.client_impl.common.ICheckSimplePasswordService;
import com.xwtech.xwecp.service.logic.client_impl.common.impl.CheckSimplePasswordServiceClientImpl;
import com.xwtech.xwecp.service.logic.pojo.QRY040105Result;
import com.xwtech.xwecp.util.DESEncrypt;

public class QRY040105Test
{
	private static final Logger logger = LoggerFactory.getLogger(QRY040105Test.class);
...
//        props.put("platform.url", "http://localhost:8090/hnmcc_ecp/xwecp.do");
		...
		ICheckSimplePasswordService c = new CheckSimplePasswordServiceClientImpl();
		QRY040105Result result = c.checkSimplePassword("15890158325","675645");
		...
		if (result != null)
		{
			...
			logger.info(" ====== getErrorMessage ======" + result.getState());
		}
	}
}
