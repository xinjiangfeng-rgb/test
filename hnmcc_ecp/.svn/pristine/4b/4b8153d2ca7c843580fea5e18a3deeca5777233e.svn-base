...
import com.xwtech.xwecp.service.logic.pojo.QRY300010Result;

public class QueryRightsInterestsServiceImpl extends BaseClientServiceImpl implements IQueryRightsInterestsService {
    @Override
    public QRY300010Result queryRightsInterests(Object publics, Object busiInfo) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "QRY300010";
        ...
        try {
            ...
            if (__ret instanceof QRY300010Result) {
                __result = (QRY300010Result) __ret;
            } else {
                __result = new QRY300010Result();
