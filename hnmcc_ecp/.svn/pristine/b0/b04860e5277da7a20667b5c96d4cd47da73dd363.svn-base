...
public class SubscribedBusinesServiceImpl extends BaseClientServiceImpl implements ISubscribedBusinesService {

    @Override
    public QRY420033Result SubscribedBusines(String billId, String billingCycleId) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "QRY420033";
        ...
        try {
            ...
            if (__ret instanceof QRY420033Result) {
                __result = (QRY420033Result) __ret;
            } else {
                __result = new QRY420033Result();
