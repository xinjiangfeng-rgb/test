...
public class QueryNewPointsChangeDetailsServiceImpl extends BaseClientServiceImpl implements IQueryNewPointsChangeDetailsService {

    @Override
    public QRY180528Result queryNewPointsChangeDetails(String svcNum) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "QRY180528";
        XWECPLIClient __client = XWECPLIClient.getInstance();
        ServiceMessage __msg = __client.getMsgHelper().createRequestMessage(__cmd);
        RequestData __requestData = new RequestData();
        RequestParameter __param_msisdn= new RequestParameter("SvcNum", svcNum);
        ...
        try {
            ...
            if (__ret instanceof QRY180528Result) {
                __result = (QRY180528Result) __ret;
            } else {
                __result = new QRY180528Result();
