...
public class DEL010021Test {
	private static final Logger logger = LoggerFactory.getLogger(DEL010021Test.class);
	...
	public static void main(String[] args) throws Exception
	{
		...
		DEL010021Result re = co.preCheckBusi("18236464534","4GLLB_30Y","Y","N");
		...
		if (re != null)
		{
			...
			logger.info(" ====== getPhoneNum ======" + re.getOfferCode());
			logger.info(" ====== getPkgProdId ======" + re.getOfferId());
		}
	}
}
