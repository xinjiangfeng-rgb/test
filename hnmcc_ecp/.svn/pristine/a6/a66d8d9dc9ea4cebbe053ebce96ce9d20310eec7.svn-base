...
public class PackageActivitiesServiceImpl3 implements IPackageActivitiesService3 {

    @Override
    public DEL218921Result qryPackageActivities(String billId, String basicoffreid, String ployid, String telephonist) {

        long __beginTime = System.currentTimeMillis();
        String __cmd = "DEL218921";
        ...
        try
        {
            ...
            if(__ret instanceof DEL218921Result)
            {
                __result = (DEL218921Result)__ret;
            }
            else
            {
                __result = new DEL218921Result();
