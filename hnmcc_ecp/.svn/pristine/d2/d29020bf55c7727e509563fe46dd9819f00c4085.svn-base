...
public class QueryActivityBalanceServiceClientImpl extends BaseClientServiceImpl implements IQueryActivityBalanceService
{
	public QRY010099Result queryActivityBalance(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY010099";
		...
		try
		{
			...
			if(__ret instanceof QRY010099Result)
			{
				__result = (QRY010099Result)__ret;
			}
			else
			{
				__result = new QRY010099Result();
