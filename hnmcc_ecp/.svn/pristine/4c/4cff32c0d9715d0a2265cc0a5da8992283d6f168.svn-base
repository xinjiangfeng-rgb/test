...
public class QueryUserFlowDayServiceImpl extends BaseClientServiceImpl implements IQueryUserFlowDayService
{
	public QRY161202Result queryUserFlowDay(String phoneNum,String startDay,String endDay) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY161202";
		...
		RequestParameter __param_startDay = new RequestParameter("startDay", startDay);
		__requestData.getParams().add(__param_startDay);
		...
		try
		{
			...
			if(__ret instanceof QRY161202Result)
			{
				__result = (QRY161202Result)__ret;
			}
			else
			{
				__result = new QRY161202Result ();
