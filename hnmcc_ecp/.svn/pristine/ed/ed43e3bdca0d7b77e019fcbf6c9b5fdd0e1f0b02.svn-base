...
public class QueryJfRecommendServiceImpl extends BaseClientServiceImpl implements IQueryJfRecommendService {
	...
	public QRY060001Result qryRecommend(String phoneNum,String cityCode,String eventPropertyParam) throws LIException {
		...
		try
		{
			...
			if(__ret instanceof QRY060001Result)
			{
				__result = (QRY060001Result)__ret;
			}
			else
			{
				__result = new QRY060001Result();
