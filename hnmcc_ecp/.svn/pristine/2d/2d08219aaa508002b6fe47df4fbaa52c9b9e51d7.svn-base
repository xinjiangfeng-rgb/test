...
public class QryContactGroupServiceClientImpl extends BaseClientServiceImpl implements IQryContactGroupService
{
	public QRY040109Result qryContactGroup(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040109";
		...
		try
		{
			...
			if(__ret instanceof QRY040109Result)
			{
				__result = (QRY040109Result)__ret;
			}
			else
			{
				__result = new QRY040109Result();
