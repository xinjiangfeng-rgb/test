...
//		List<PackageBean> pakcageInfo = JSON.parseArray(this.getCache().get("PKG_DA"), PackageBean.class);
//		if(pakcageInfo == null) {
//			pakcageInfo = new ArrayList<PackageBean>();
//			List<Map<String,Object>> ret = (List<Map<String,Object>>)this.getJdbcTemplate().queryForList("SELECT * FROM T_PKG_BOSS_DESC_DA");
...
//			this.getCache().add("PKG_DA", JSON.toJSONString(pakcageInfo));
//		}
//
//		return pakcageInfo;
//
...
//		List<Map<String,Object>> pakcageInfo = JSON.parseObject(this.getCache().get("PKG_EXG_EXCEPT_LIST_" + pakNum), new TypeReference<List<Map<String, Object>>>(){});
//		if(pakcageInfo == null) {
//			String sql = "SELECT F_CHANNEL_NUM, F_AREA_NUM, F_PRODUCT_ID_BOSS, F_BZ FROM T_PKG_EXG_LIST WHERE F_PRODUCT_ID_BOSS = ? ";
//			Object obj[] = new Object[1];
//			obj[0] = pakNum;
//			pakcageInfo = (List<Map<String,Object>>)this.getJdbcTemplate().queryForList(sql, obj);
////			this.getCache().add("PKG_EXG_EXCEPT_LIST_" + pakNum, pakcageInfo);
//			this.getCache().add("PKG_EXG_EXCEPT_LIST_" + pakNum, JSON.toJSONString(pakcageInfo));
//		}
//
...
//		List<Map<String,Object>> pakcageInfo = JSON.parseObject(this.getCache().get("PKG_EXG_EXCEPT_LIST_" + pakNum + "_" + city), new TypeReference<List<Map<String,Object>>>(){});
//		if(pakcageInfo == null) {
...
//			this.getCache().add("PKG_EXG_EXCEPT_LIST_" + pakNum+"_"+city, JSON.toJSONString(pakcageInfo));
//		}
//
//		if(pakcageInfo != null && pakcageInfo.size() > 0) {
//			return true;
...
//		List<PkgExgSelectBean> pkgExgSelectLst = JSON.parseArray(this.getCache().get("PKG_EXG_SELECT_LIST_"+area+"_"+proId), PkgExgSelectBean.class);
...
//			obj[0] = area;
//			obj[1] = proId;
//			List<Map<String,Object>> ret = (List<Map<String,Object>>)this.getJdbcTemplate().queryForList(sql, obj);
...
//			this.getCache().add("PKG_EXG_SELECT_LIST_"+area+"_"+proId, JSON.toJSONString(pkgExgSelectLst));
//		}
//
...
//		List<PkgExgNeedBusiInfo> pkgExgNeedBusiLst = JSON.parseArray(this.getCache().get("PKG_EXG_NEED_BUSI_LIST_" + area + "_" + pkgNumEcp), PkgExgNeedBusiInfo.class);
...
//			this.getCache().add("PKG_EXG_NEED_BUSI_LIST_" + area + "_" + pkgNumEcp, JSON.toJSONString(pkgExgNeedBusiLst));
//		}
//
...
//		Object obj[] = new Object[1];
//		obj[0] = city;
//		List<Map<String,Object>> list = this.getJdbcTemplate().queryForList(sql,obj);
//		if(list != null){
...
//		List<String> groupNameList = JSON.parseArray(this.getCache().get("CONTY_GROUP_NAME_" + city), String.class);
//		if(groupNameList == null) {
//			String sql = "select F_GROUP_NAME from T_GROUP_DA where F_CITY = ? ";
//			Object obj[] = new Object[1];
//			obj[0] = city;
//			groupNameList = new ArrayList<String>();
//			List<Map<String,Object>> list = (List<Map<String,Object>>)this.getJdbcTemplate().queryForList(sql, obj);
//			if(list != null){
//				for(int i = 0; i < list.size(); i++)
//				{
//					Map m = list.get(i);
...
//			this.getCache().add("CONTY_GROUP_NAME_" + city, JSON.toJSONString(groupNameList));
//		}
//
...
//	 */
//	public List<Map<String,Object>> getFluxPkgCode(String fluxPkgType) throws DAOException {
//
////		List<Map> fluxPkgLst = (List<Map>)(this.getCache().get("PKG_FLUX_LIST_" + fluxPkgType));
//		List<Map<String,Object>> fluxPkgLst = JSON.parseObject(this.getCache().get("PKG_FLUX_LIST_" + fluxPkgType), new TypeReference<List<Map<String, Object>>>(){});
//		if(fluxPkgLst == null) {
//			String sql = "select F_PKG_CODE, F_PKG_TYPE, F_PKG_NAME, F_TYPE_NAME from T_FLUX_PKG_INFO where F_PKG_UNIT='4' and F_PKG_TYPE = ? ";
//			Object obj[] = new Object[1];
//			obj[0] = fluxPkgType;
//			fluxPkgLst = (List<Map<String,Object>>)this.getJdbcTemplate().queryForList(sql, obj);
////			this.getCache().add("PKG_FLUX_LIST_" + fluxPkgType, fluxPkgLst);
//			this.getCache().add("PKG_FLUX_LIST_" + fluxPkgType, JSON.toJSONString(fluxPkgLst));
//		}
//
//		return fluxPkgLst;
//	}
...
//		List<CountryNetworkInfo> couNetInfoList = JSON.parseArray(this.getCache().get("t_group_da_new_"+region+"_"+countryId), CountryNetworkInfo.class);
//
...
//				this.getCache().add("t_group_da_new_"+region+"_"+countryId, JSON.toJSONString(couNetInfoList));
//			}
//		}
...
//		List<FamMemUserProductId> famMemUserProList = JSON.parseArray(this.getCache().get("t_family_meb_ber_"+region), FamMemUserProductId.class);
...
//				this.getCache().add("t_family_meb_ber_"+region,JSON.toJSONString(famMemUserProList));
//			}
//		}
...
//		List<String> listPkg = JSON.parseArray(this.getCache().get("t_pkg_cfg"+productId), String.class);
//		if(listPkg==null)
//		{
...
//				this.getCache().add("t_pkg_cfg"+productId,JSON.toJSONString(listPkg));
//			}
//		}
//		return listPkg;
//	}
