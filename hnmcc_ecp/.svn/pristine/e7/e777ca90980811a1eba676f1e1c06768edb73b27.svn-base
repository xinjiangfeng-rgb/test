...
import com.xwtech.xwecp.service.logic.client_impl.common.IOrderIsExistsService;
import com.xwtech.xwecp.service.logic.client_impl.common.impl.OrderIsExistsServiceClientImpl;
...
{
	private static final Logger logger = LoggerFactory.getLogger(QRY040107Test.class);
...
//		props.put("platform.url", "http://192.168.16.226:8080/obsh_ecp/xwecp.do");
		...
		IOrderIsExistsService c = new OrderIsExistsServiceClientImpl();
		QRY040107Result result = c.orderIsExists("18803695181", "93713167205");
		if (result != null)
		{
			...
			logger.info(" ====== getRet_code ======" + result.getRet_code());
			logger.info(" ====== getRet_msg ======" + result.getRet_msg());
		}
	}
}
