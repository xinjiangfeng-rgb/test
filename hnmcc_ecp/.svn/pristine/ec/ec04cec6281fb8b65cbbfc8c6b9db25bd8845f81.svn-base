...
public class QueryZXYZInfoServiceClientImpl implements IQueryZXYZInfoService
{
        ...
        throws LIException
    {
        ...
        try
        {
            ...
            if (__ret instanceof QRY020022Result)
            {
                __result = (QRY020022Result)__ret;
            }
            else
            {
                __result = new QRY020022Result();
