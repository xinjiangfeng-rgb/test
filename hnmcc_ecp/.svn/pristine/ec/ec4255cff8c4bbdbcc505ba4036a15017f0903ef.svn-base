...
public class ChangesBasicFeesTmServiceImpl extends BaseClientServiceImpl implements IChangesBasicFeesTmService {
    @Override
    public DEL930048Result changesBasicFeesTm(String svcNum, String instanceId, String mainProdPrcParaValue, String mainProdPrcCustParaType, String optrId, String telephonist) throws LIException {
        ...
        try {
            ...
            if (__ret instanceof DEL930048Result) {
                __result = (DEL930048Result) __ret;
            } else {
                __result = new DEL930048Result();
