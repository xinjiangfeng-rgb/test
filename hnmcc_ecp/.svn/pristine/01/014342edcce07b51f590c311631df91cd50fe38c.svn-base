...
public class AddedChangeBasicProductsTcServiceImpl extends BaseClientServiceImpl implements IAddedChangeBasicProductsTcService {
    @Override
    public DEL190521Result addedChangeBasicProductsTc(String svcNum, String prodId, String offerOthers, String offerPloy) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "DEL190521";
        ...
        try {
            ...
            if (__ret instanceof DEL190521Result) {
                __result = (DEL190521Result) __ret;
            } else {
                __result = new DEL190521Result();
