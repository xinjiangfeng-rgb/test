...
public class BillAccountInformationServiceImpl extends BaseClientServiceImpl implements IBillAccountInformationService {


    @Override
    public QRY420034Result billAccountInformation(String billId, String billingCycleId) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "QRY420034";
        ...
        try {
            ...
            if (__ret instanceof QRY420034Result) {
                __result = (QRY420034Result) __ret;
            } else {
                __result = new QRY420034Result();
