...
import com.xwtech.xwecp.service.logic.client_impl.common.IQueryVerificationCarryOutRuleService;
import com.xwtech.xwecp.service.logic.pojo.QRY180716Result;

public class QueryVerificationCarryOutRuleServiceImpl extends BaseClientServiceImpl implements IQueryVerificationCarryOutRuleService {
    @Override
    public QRY180716Result queryVerificationCarryOutRule(String billId, String custName, String credNumber, String flag, String IS_ACTION) throws LIException {
        ...
        RequestParameter __param_credNumber = new RequestParameter("credNumber", credNumber);
        __requestData.getParams().add(__param_credNumber);
        RequestParameter __param_flag = new RequestParameter("flag", flag);
        __requestData.getParams().add(__param_flag);
        RequestParameter __param_isAction = new RequestParameter("IS_ACTION", IS_ACTION);
        __requestData.getParams().add(__param_isAction);
        ...
        try {
            ...
            if (__ret instanceof QRY180716Result) {
                __result = (QRY180716Result) __ret;
            } else {
                __result = new QRY180716Result();
