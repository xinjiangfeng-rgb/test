...
//
//	private static final Logger logger = LoggerFactory.getLogger(InterfaceDAO.class);
//
...
//////		sql.append("update  openapi.unip_addorder t set t.ORDERSTATUS = 2 where T.ORDERID = ?");//测试环境
////		//现网环境
////		sql.append("update xwmall.to_order_net  t set t.f_result = ? where T.f_order_num = ?");
////		try
////		{
