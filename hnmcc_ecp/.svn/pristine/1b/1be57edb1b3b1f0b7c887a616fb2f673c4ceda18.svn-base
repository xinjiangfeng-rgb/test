...
public class LoginServiceClientImpl extends BaseClientServiceImpl implements ILoginService
{
	public QRY040010Result login(String phoneNum, String password) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040010";
		...
		try
		{
			...
			if(__ret instanceof QRY040010Result)
			{
				__result = (QRY040010Result)__ret;
			}
			else
			{
				__result = new QRY040010Result();
