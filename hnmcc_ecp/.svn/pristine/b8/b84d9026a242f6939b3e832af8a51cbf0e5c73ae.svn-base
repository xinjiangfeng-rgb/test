...
public class QueryMainDeputyCardHistoryServiceImpl extends BaseClientServiceImpl implements IQueryMainDeputyCardHistoryService {
    @Override
    public QRY191211Result queryMainDeputyCardHistory(String svcNum, String month) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "QRY191211";
        ...
        RequestParameter __param_month= new RequestParameter("month", month);
        __requestData.getParams().add(__param_month);
        ...
        try {
            ...
            if (__ret instanceof QRY191211Result) {
                __result = (QRY191211Result) __ret;
            } else {
                __result = new QRY191211Result();
