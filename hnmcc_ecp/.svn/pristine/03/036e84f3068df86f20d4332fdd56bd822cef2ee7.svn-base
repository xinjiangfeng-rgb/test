...
public class QueryGPRSPkgFluxServiceClientImpl extends BaseClientServiceImpl implements IQueryGPRSPkgFluxService
{
	public QRY040045Result qryGPRSPkgFlux(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040045";
		...
		try
		{
			...
			if(__ret instanceof QRY040045Result)
			{
				__result = (QRY040045Result)__ret;
			}
			else
			{
				__result = new QRY040045Result();
