...
public class UnsubscribeAddChangeBasicproductServiceImpl extends BaseClientServiceImpl implements IUnsubscribeAddChangeBasicproductService {
    @Override
    public DEL190523Result usubscribeAddChangeBasicproduct(String svcNum, String prodId, String offerOthers, String offerPloy) throws LIException {
        ...
        try {
            ...
            if (__ret instanceof DEL190523Result) {
                __result = (DEL190523Result) __ret;
            } else {
                __result = new DEL190523Result();
