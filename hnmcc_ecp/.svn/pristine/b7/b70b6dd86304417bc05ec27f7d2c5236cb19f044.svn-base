...
import com.xwtech.xwecp.service.logic.client_impl.common.IChangesAddedProductTmService;
import com.xwtech.xwecp.service.logic.pojo.DEL980012Result;

public class ChangesAddedProductTmServiceImpl extends BaseClientServiceImpl implements IChangesAddedProductTmService {
    @Override
    public DEL980012Result changesAddedProductTm(String svcNum, String operMode, String prodCustomParaType, String addProdPrcId, String prodPrcPara, String optrId, String telephonist) throws LIException {

        long __beginTime = System.currentTimeMillis();
        String __cmd = "DEL980012";
        ...
        try {
            ...
            if (__ret instanceof DEL980012Result) {
                __result = (DEL980012Result) __ret;
            } else {
                __result = new DEL980012Result();
