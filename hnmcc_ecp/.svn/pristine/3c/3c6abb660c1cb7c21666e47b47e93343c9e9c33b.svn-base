...
//	private static final Logger logger = LoggerFactory.getLogger(YingXingCardDaoImpl.class);
//	/**
//	 * 取缓存数据库
//	 * 有数据那么就是迎接卡
//	 */
...
//
//			List<Map<String,Object>> ret = (List<Map<String,Object>>)this.getJdbcTemplate().queryForList(sql,objects);
//
