...
public class FlowGjServiceImpl extends BaseClientServiceImpl implements IFlowGjService {

	@Override
	public QRY161108Result qryFlowGj(String phoneNum) throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY161108";
		...
		try
		{
			...
			if(__ret instanceof QRY161108Result)
			{
				__result = (QRY161108Result)__ret;
			}
			else
			{
				__result = new QRY161108Result();
