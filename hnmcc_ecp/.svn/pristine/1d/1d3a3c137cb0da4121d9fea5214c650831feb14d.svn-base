...
public class QueryAccountNameByPhoneServiceImpl  extends BaseClientServiceImpl implements IQueryAccountNameByPhoneService {


    @Override
    public QRY170422Result queryAccountNameByPhone(String SVCNUM) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "QRY170422";
        ...
        try {
            ...
            if (__ret instanceof QRY170422Result) {
                __result = (QRY170422Result) __ret;
            } else {
                __result = new QRY170422Result();
