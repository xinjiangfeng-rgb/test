...
public class ConsumptionTrendAnalysisServiceImpl extends BaseClientServiceImpl implements IConsumptionTrendAnalysisService {


    @Override
    public QRY420032Result consumptionTrendAnalysis(String billId, String billingCycleId) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "QRY420032";
        ...
        try {
            ...
            if (__ret instanceof QRY420032Result) {
                __result = (QRY420032Result) __ret;
            } else {
                __result = new QRY420032Result();
