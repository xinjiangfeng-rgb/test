...
import com.xwtech.xwecp.service.logic.client_impl.common.impl.FiberOpticBroadbandServiceImpl;
...
public class QRY201512Test {

    private static final Logger logger = LoggerFactory.getLogger(QRY201512Test.class);
...
//        props.put("platform.url", "http://localhost:8082/hnmcc_ecp/xwecp.do");
        ...
        IFiberOpticBroadbandService co = new FiberOpticBroadbandServiceImpl();
        QRY201512Result re = co.queryFiberOpticBroadband("15093421454");
