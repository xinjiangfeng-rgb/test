...
public class QueryOperDetailServiceClientImpl extends BaseClientServiceImpl implements IQueryOperDetailService
{
	public QRY040004Result queryOperDetail(String phoneNum, String beginDate, String endDate) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040004";
		...
		try
		{
			...
			if(__ret instanceof QRY040004Result)
			{
				__result = (QRY040004Result)__ret;
			}
			else
			{
				__result = new QRY040004Result();
