...
public class QueryPukServiceClientImpl extends BaseClientServiceImpl implements IQueryPukService
{
	public QRY040007Result queryPuk(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040007";
		...
		try
		{
			...
			if(__ret instanceof QRY040007Result)
			{
				__result = (QRY040007Result)__ret;
			}
			else
			{
				__result = new QRY040007Result();
