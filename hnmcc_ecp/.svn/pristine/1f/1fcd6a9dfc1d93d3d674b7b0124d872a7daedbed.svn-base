...
public class QrypackageInfoServiceNewImpl extends BaseClientServiceImpl implements IQrypackageInfoNewService
{
	public QRY040201Result qrypackageInfo(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040201";
		...
		try
		{
			...
			if(__ret instanceof QRY040201Result)
			{
				__result = (QRY040201Result)__ret;
			}
			else
			{
				__result = new QRY040201Result();
