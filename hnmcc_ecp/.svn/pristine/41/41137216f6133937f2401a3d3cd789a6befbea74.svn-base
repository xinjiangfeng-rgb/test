...
public class QueryUserPushToMailBoxServiceImpl extends BaseClientServiceImpl implements IQueryUserPushToMailboxService {
	@Override
	public QRY139139Result queryUserPushToMailbox(String keyNum, String qryType, String billingCycleId) throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY139139";
		...
		try
		{
			...
			if(__ret instanceof QRY139139Result)
			{
				__result = (QRY139139Result)__ret;
			}
			else
			{
				__result = new QRY139139Result();
