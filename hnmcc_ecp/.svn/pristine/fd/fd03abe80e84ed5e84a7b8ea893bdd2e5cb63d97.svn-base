...
public class QueryBillBalServiceClientImpl extends BaseClientServiceImpl implements IQueryBillBalService
{
	public QRY010021Result queryBillBal(String msisdn, String extQueryDateYm) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY010021";
		...
		try
		{
			...
			if(__ret instanceof QRY010021Result)
			{
				__result = (QRY010021Result)__ret;
			}
			else
			{
				__result = new QRY010021Result();
