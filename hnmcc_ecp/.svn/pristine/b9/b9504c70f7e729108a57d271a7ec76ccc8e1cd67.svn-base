...
public class QueryScoreExchangeDetailServiceClientImpl extends BaseClientServiceImpl implements IQueryScoreExchangeDetailService
{
	public QRY030003Result queryScoreExchangeDetail(String phoneNum, String beginDate, String endDate) throws LIException
	{
		...
		try
		{
			...
			if(__ret instanceof QRY030003Result)
			{
				__result = (QRY030003Result)__ret;
			}
			else
			{
				__result = new QRY030003Result();
