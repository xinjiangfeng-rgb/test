...
import com.xwtech.xwecp.service.logic.client_impl.common.impl.QueryLineUpstateServiceImpl;
import com.xwtech.xwecp.service.logic.pojo.QRY180120Result;
import org.jboss.logging.Logger;

import java.util.Properties;

public class QRY180120Test {
...
//        props.put("platform.url", "http://localhost:8080/hnmcc_ecp/xwecp.do");
        ...
        IQueryLineUpstateService co = new QueryLineUpstateServiceImpl();
        QRY180120Result ret = co.queryLineUpState("15837179491", "201374", "0", "0");
