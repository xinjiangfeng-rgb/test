...
public class AddedChangeBasicProductsServiceImpl  extends BaseClientServiceImpl implements IAddedChangeBasicProductsService {
    @Override
    public DEL190520Result addedChangeBasicProducts(String svcNum, String prodId, String offerOthers, String offerPloy) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "DEL190520";
        ...
        try {
            ...
            if (__ret instanceof DEL190520Result) {
                __result = (DEL190520Result) __ret;
            } else {
                __result = new DEL190520Result();
