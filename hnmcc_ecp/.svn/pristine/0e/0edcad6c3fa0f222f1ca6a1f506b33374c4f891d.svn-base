...
public class QueryCurrentBalanceServiceClientImpl extends BaseClientServiceImpl implements IQueryCurrentBalanceService
{
	public QRY010098Result queryCurrentBalance(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY010098";
		...
		try
		{
			...
			if(__ret instanceof QRY010098Result)
			{
				__result = (QRY010098Result)__ret;
			}
			else
			{
				__result = new QRY010098Result();
