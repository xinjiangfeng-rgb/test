...
public class QueryFreeResourceInfoServiceClientImpl implements IQueryFreeResourceInfoService
{
    
    @Override
    public QRY020021Result queryFreeResourceInfo(String phoneNum)
        throws LIException
    {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "QRY020021";
        ...
        try
        {
            ...
            if (__ret instanceof QRY020021Result)
            {
                __result = (QRY020021Result)__ret;
            }
            else
            {
                __result = new QRY020021Result();
