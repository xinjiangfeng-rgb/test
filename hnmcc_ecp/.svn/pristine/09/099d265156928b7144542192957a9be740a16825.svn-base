...
public class CheckSimplePasswordServiceClientImpl extends BaseClientServiceImpl implements ICheckSimplePasswordService
{
	public QRY040105Result checkSimplePassword(String phoneNum, String password) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040105";
		...
		try
		{
			...
			if(__ret instanceof QRY040105Result)
			{
				__result = (QRY040105Result)__ret;
			}
			else
			{
				__result = new QRY040105Result();
