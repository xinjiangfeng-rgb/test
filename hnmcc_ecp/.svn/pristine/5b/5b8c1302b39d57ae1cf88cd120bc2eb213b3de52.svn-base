...
//		Map bossLogRecordMap = (Map) (JSON.parseObject(this.getCache().get("T_BOSSLOG_RECORD_FLAG")));
//
...
//				this.getCache().add("T_BOSSLOG_RECORD_FLAG" ,JSON.toJSONString(bossLogRecordMap));
//			}
//		}
//		return bossLogRecordMap;
//	}
