...
public class QueryMainAndSubCardsInfoNewServiceImpl extends BaseClientServiceImpl implements IQueryMainAndSubCardsInfoNewService {
    @Override
    public QRY180820Result queryMainAndSubCardsInfoNew(String SvcNum, String IsAblity) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "QRY180820";
        ...
        try {
            ...
            if (__ret instanceof QRY180820Result) {
                __result = (QRY180820Result) __ret;
            } else {
                __result = new QRY180820Result();
