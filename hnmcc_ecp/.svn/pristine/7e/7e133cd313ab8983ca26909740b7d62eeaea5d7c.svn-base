...
public class QueryRelationNumServiceClientImpl extends BaseClientServiceImpl implements IQueryRelationNumService
{
	public QRY050001Result queryRelationNum(String phoneNum,String qryType) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY050001";
		...
		try
		{
			...
			if(__ret instanceof QRY050001Result)
			{
				__result = (QRY050001Result)__ret;
			}
			else
			{
				__result = new QRY050001Result();
