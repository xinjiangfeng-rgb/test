...
import com.xwtech.xwecp.service.logic.client_impl.common.impl.QueryCallDurationClientImpl;
import com.xwtech.xwecp.service.logic.pojo.QRY040102Result;

public class QRY040102Test {
	private static final Logger logger = LoggerFactory.getLogger(QRY040102Test.class);
...
//		props.put("platform.url", "http://127.0.0.1:8080/hnmcc_ecp/xwecp.do");
		...
		IQueryCallDurationService co = new QueryCallDurationClientImpl();
		QRY040102Result re = co.queryCallDuration("15837179491","2017010");
		...
		if (re != null) {
			...
			logger.info(" === re.getBossCode() === " + re.getCallDuration());
		}
	}
}