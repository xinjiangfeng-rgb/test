...
import com.xwtech.xwecp.service.logic.client_impl.common.impl.QueryPersonBusinessImpl;
...
//      props.put("platform.url", "http://localhost:8082/hnmcc_ecp/xwecp.do");
        ...
        IQueryPersonBusiness queryPersonBusiness = new QueryPersonBusinessImpl();
        System.out.println(JSON.toJSONString(queryPersonBusiness.queryBusiness("15093421454", "JBFWB")));
