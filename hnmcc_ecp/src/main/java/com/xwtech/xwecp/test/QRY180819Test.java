...
import com.xwtech.xwecp.service.logic.client_impl.common.impl.QueryMainAndSubCardsInfoServiceImpl;
 ...
 *'cc_180819
 * */
public class QRY180819Test {

    private static final Logger logger = Logger.getLogger(QRY180819Test.class);
...
//        props.put("platform.url", "http://127.0.0.1:8082/hnmcc_ecp/xwecp.do");
        ...
        lic.setContextParameter(ic);
            IQueryMainAndSubCardsInfoService co = new QueryMainAndSubCardsInfoServiceImpl();
            //SvcNum    手机号码
            //IsAblity 是否通过能力开放平台调用   直接输入 Y15238341442
            System.out.println(JSON.toJSONString(co.queryMainAndSubCardsInfo("13721449604", "1")));
