...
import com.xwtech.xwecp.service.logic.client_impl.common.impl.QueryEffectTypeImpl;
import com.xwtech.xwecp.service.logic.pojo.DEL010032Result;

public class DEL010032Test {
	...
	public static void main(String[] args) {
		...
		IQueryEffectType co = new QueryEffectTypeImpl();
		DEL010032Result re = null;
		try {
			re = co.queryEffect("15890158325", "JBFWB", "1241241");
		} catch (Exception e) {
			e.printStackTrace();
		}
