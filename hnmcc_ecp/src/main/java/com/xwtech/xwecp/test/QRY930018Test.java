...
import com.xwtech.xwecp.service.logic.client_impl.common.impl.TransactBusinessImpl;
...
//        ITransactBusinessService co = new TransactBusinessServiceClientImpl();
        ...
        ITransactBusiness tr = new TransactBusinessImpl();
        QRY930018Result ret = tr.transactBusiness("18236464534", "100160000355", "ADD", "YZZZZDSYYT");
