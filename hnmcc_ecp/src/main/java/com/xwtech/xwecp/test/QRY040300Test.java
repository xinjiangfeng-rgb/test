...
import com.xwtech.xwecp.service.logic.client_impl.common.impl.RedMemberServiceImpl;
import com.xwtech.xwecp.service.logic.pojo.QRY040300Result;
import org.slf4j.Logger;import org.slf4j.LoggerFactory;
import java.util.Properties;

public class QRY040300Test
{
	private static final Logger logger = LoggerFactory.getLogger(QRY040300Test.class);
...
//		props.put("platform.url", "http://192.168.16.226:8080/obsh_ecp/xwecp.do");
		...
		IRedMemberService co = new RedMemberServiceImpl();
		QRY040300Result result = co.queryRedMember("18703845086");
