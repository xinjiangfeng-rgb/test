...
public class QRY170411Test {

	private static final Logger logger = LoggerFactory.getLogger(QRY170411Test.class);
	...
	public static void main(String args[]){
		...
		IQueryPkgConsumeService QueryPkgConsumeService = new QueryPkgConsumeServiceImpl();
		
		QRY170411Result ret = 	QueryPkgConsumeService.queryPkgConsume("18338228259","","201801");
