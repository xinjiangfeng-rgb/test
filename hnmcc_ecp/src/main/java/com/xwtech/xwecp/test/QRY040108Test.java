...
import com.xwtech.xwecp.service.logic.client_impl.common.IQueryBalanceGroupService;
import com.xwtech.xwecp.service.logic.client_impl.common.impl.QueryBalanceGroupServiceClientImpl;
...
{
	private static final Logger logger = LoggerFactory.getLogger(QRY040108Test.class);
...
//		props.put("platform.url", "http://192.168.16.226:8080/obsh_ecp/xwecp.do");
		...
		System.out.println(DESEncrypt.desString("112233", BOSS_SECRET_KEY));
		 IQueryBalanceGroupService co = new QueryBalanceGroupServiceClientImpl();
		QRY040108Result result = co.queryBalance("93713167205");
		if (result != null)
		{
