...
public class QueryNewRealTimeBillingServiceClientImpl extends BaseClientServiceImpl implements IQueryNewRealTimeBillingService
{
	public QRY010018Result queryNewRealTimeBilling(String phoneNum,String startcycle) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY010018";
		...
		try
		{
			...
			if(__ret instanceof QRY010018Result)
			{
				__result = (QRY010018Result)__ret;
			}
			else
			{
				__result = new QRY010018Result();
