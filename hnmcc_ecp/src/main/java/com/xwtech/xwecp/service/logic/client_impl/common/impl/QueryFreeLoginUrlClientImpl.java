...
public class QueryFreeLoginUrlClientImpl extends BaseClientServiceImpl implements IQueryFreeLoginUrlService
{
	public QRY040100Result getFreeLoginUrl(String phoneNum, String smsCode) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040100";
		...
		RequestParameter __param_smsCode = new RequestParameter("smsCode", smsCode);
		__requestData.getParams().add(__param_smsCode);
		...
		try
		{
			...
			if(__ret instanceof QRY040100Result)
			{
				__result = (QRY040100Result)__ret;
			}
			else
			{
				__result = new QRY040100Result();
