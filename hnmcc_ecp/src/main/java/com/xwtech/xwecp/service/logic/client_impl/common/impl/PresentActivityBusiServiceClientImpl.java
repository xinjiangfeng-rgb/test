...
public class PresentActivityBusiServiceClientImpl extends BaseClientServiceImpl implements IPresentActivityBusiService
{
	public DEL010023Result presentActivityBusi(String phoneNumA,String phoneNum, String flag, String prodPrcId,String paypath) throws LIException
	{
		...
		RequestParameter __param_phoneNumA = new RequestParameter("phoneNumA", phoneNumA);
		__requestData.getParams().add(__param_phoneNumA);
