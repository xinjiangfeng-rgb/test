...
public class QueryCurrentMonthFeeServiceImpl extends BaseClientServiceImpl implements IQueryCurrentMonthFeeService {

	@Override
	public QRY920013Result currentMonthFee(String phoneNum) throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY920013";
		...
		try
		{
			...
			if(__ret instanceof QRY920013Result)
			{
				__result = (QRY920013Result)__ret;
			}
			else
			{
				__result = new QRY920013Result();
