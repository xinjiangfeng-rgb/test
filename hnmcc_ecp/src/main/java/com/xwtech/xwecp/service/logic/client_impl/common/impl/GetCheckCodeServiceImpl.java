...
public class GetCheckCodeServiceImpl extends BaseClientServiceImpl implements IGetCheckCodeService
{
	public QRY040094Result getCheckCode(String phoneNum,String content) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040094";
		...
		try
		{
			...
			if(__ret instanceof QRY040094Result)
			{
				__result = (QRY040094Result)__ret;
			}
			else
			{
				__result = new QRY040094Result();
