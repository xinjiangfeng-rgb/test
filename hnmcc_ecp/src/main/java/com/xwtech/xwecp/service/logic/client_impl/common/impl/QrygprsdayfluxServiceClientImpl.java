...
public class QrygprsdayfluxServiceClientImpl extends BaseClientServiceImpl
		implements IQrygprsdayfluxService {

	public QRY040064Result qryGprsDayFlux(String phoneNum,String startDate,String endDate)
			throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040064";
		...
		try
		{
			...
			if(__ret instanceof QRY040064Result)
			{
				__result = (QRY040064Result)__ret;
			}
			else
			{
				__result = new QRY040064Result();
