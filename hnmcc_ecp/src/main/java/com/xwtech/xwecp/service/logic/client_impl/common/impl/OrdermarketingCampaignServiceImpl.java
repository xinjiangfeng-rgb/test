...
public class OrdermarketingCampaignServiceImpl extends BaseClientServiceImpl implements IOrdermarketingCampaignService {
    @Override
    public DEL190123Result ordermarketingCampaign(String flag, String payPath, String authNum, String passWd, String svcNum, String svcNumA, String prodPrcId, String channelSource, String partnerNumber, String bossCode) throws LIException {

        long __beginTime = System.currentTimeMillis();
        String __cmd = "DEL190123";
...
//		__requestData.getParams().add(__param_phoneNum);
        ...
        try {
            ...
            if (__ret instanceof DEL190123Result) {
                __result = (DEL190123Result) __ret;
            } else {
                __result = new DEL190123Result();
