...
public class QueryBroadTvByPhoneOrBasicServiceImpl extends BaseClientServiceImpl implements IQueryBroadTvByPhoneOrBasicService {


    @Override
    public QRY190108Result queryBroadTvByPhoneOrBasic(String billId, String offerId) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "QRY190108";
        ...
        try {
            ...
            if (__ret instanceof QRY190108Result) {
                __result = (QRY190108Result) __ret;
            } else {
                __result = new QRY190108Result();
