...
public class OrderMarketingActivitiesServiceImpl extends BaseClientServiceImpl implements IOrderMarketingActivitiesService {
    public DEL300002Result orderMarketingBusi(String phoneNum, String flag, String prodPrcId, String partnerNumber, String bossCode) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "DEL300002";
        ...
        RequestParameter __param_partnerNumber = new RequestParameter("partnerNumber", partnerNumber);
        __requestData.getParams().add(__param_partnerNumber);
        RequestParameter __param_bossCode = new RequestParameter("bossCode", bossCode);
        __requestData.getParams().add(__param_bossCode);
        ...
        try {
            ...
            if (__ret instanceof DEL300002Result) {
                __result = (DEL300002Result) __ret;
            } else {
                __result = new DEL300002Result();
    ...
    public DEL300002Result orderMarketingBusiChannelSource(String phoneNum, String flag, String prodPrcId, String partnerNumber, String bossCode, String channelSource) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "DEL300002";
        XWECPLIClient __client = XWECPLIClient.getInstance();
        ServiceMessage __msg = __client.getMsgHelper().createRequestMessage(__cmd);
