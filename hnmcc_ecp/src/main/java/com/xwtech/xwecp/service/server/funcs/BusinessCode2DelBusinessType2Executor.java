...
{
    private static final Logger logger = LoggerFactory.getLogger(BusinessCode2DelBusinessType2Executor.class);
    ...
    public String execute(String parameter)
    {
        ...
        try
        {
            busiType = this.wellFormedDAO.getBusiParm2(parameters[0], "DEL010001", "", parameters[1]);
        }
        catch (Exception e)
        {
