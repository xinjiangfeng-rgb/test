...
@Component
public class BusinessCode2DelBusinessType3Executor extends AbstractFunctionExecutor 
{
	private static final Logger logger = LoggerFactory.getLogger(BusinessCode2DelBusinessType3Executor.class);
...
private WellFormedDAO wellFormedDAO;
	...
	public BusinessCode2DelBusinessType3Executor()
	{
	...
	public String execute(String parameter)
	{
		...
		try
		{
			busiType = this.wellFormedDAO.getBusiParm(parameter, "DEL040015", "");
		}
		catch (Exception e)
		{
