...
public class QrypackageInfoServiceClientImpl extends BaseClientServiceImpl implements IQrypackageInfoService
{
	public QRY040037Result qrypackageInfo(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040037";
		...
		try
		{
			...
			if(__ret instanceof QRY040037Result)
			{
				__result = (QRY040037Result)__ret;
			}
			else
			{
				__result = new QRY040037Result();
