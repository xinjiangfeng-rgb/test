...
public class QueryMonthlyTrafficServiceImpl extends BaseClientServiceImpl
		implements IQueryMonthlyTrafficService {
	...
	public QRY040050Result queryMonthlyTraffic(String phoneNum, String billingCycle, String cycleEndDay, String cycleBeginDate, String cycleEndDate) throws LIException {
		...
		RequestParameter __param_cycleEndDay = new RequestParameter("cycleEndDay", cycleEndDay);
		__requestData.getParams().add(__param_cycleEndDay);
		...
		try
		{
			...
			if(__ret instanceof QRY040050Result)
			{
				__result = (QRY040050Result)__ret;
			}
			else
			{
				__result = new QRY040050Result();
