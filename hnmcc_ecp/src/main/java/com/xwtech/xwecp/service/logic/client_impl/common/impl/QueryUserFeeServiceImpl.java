...
public class QueryUserFeeServiceImpl extends BaseClientServiceImpl implements IQueryUserFeeService
{
	public QRY161201Result queryUserFee(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY161201";
		...
		try
		{
			...
			if(__ret instanceof QRY161201Result)
			{
				__result = (QRY161201Result)__ret;
			}
			else
			{
				__result = new QRY161201Result ();
