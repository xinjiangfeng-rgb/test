...
public class QueryBalScoreServiceClientImpl extends BaseClientServiceImpl implements IQueryBalScoreService
{
	public QRY040002Result queryBalScore(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040002";
		...
		try
		{
			...
			if(__ret instanceof QRY040002Result)
			{
				__result = (QRY040002Result)__ret;
			}
			else
			{
				__result = new QRY040002Result();
