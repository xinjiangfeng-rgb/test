...
public class QueryUserInfoServiceClientImpl extends BaseClientServiceImpl implements IQueryUserInfoService
{
	public QRY040001Result queryUserInfo(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040001";
		...
		try
		{
			...
			if(__ret instanceof QRY040001Result)
			{
				__result = (QRY040001Result)__ret;
			}
			else
			{
				__result = new QRY040001Result();
