...
public class QueryFluxInfClientImpl extends BaseClientServiceImpl implements IQueryFluxInfService
{
	public QRY040111Result queryFluxInf(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040111";
		...
		try
		{
			...
			if(__ret instanceof QRY040111Result)
			{
				__result = (QRY040111Result)__ret;
			}
			else
			{
				__result = new QRY040111Result();
