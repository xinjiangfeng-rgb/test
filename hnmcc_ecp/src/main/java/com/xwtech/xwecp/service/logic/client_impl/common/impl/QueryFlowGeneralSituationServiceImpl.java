...
public class QueryFlowGeneralSituationServiceImpl extends BaseClientServiceImpl implements IQueryFlowGeneralSituationService
{
	public QRY161204Result queryFlowGeneralSituation(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY161204";
		...
		try
		{
			...
			if(__ret instanceof QRY161204Result)
			{
				__result = (QRY161204Result)__ret;
			}
			else
			{
				__result = new QRY161204Result ();
