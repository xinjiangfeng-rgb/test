...
public class QueryCurrentPriceNewByPhoneServiceImpl extends BaseClientServiceImpl implements IQueryCurrentPriceNewByPhoneService {
    @Override
    public QRY190425Result queryCurrentPriceNewByPhone(String billId) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "QRY190425";
        ...
        try {
            ...
            if (__ret instanceof QRY190425Result) {
                __result = (QRY190425Result) __ret;
            } else {
                __result = new QRY190425Result();
