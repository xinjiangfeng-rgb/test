...
public class QueryCurrentPriceByPhoneServiceImpl extends BaseClientServiceImpl implements IQueryCurrentPriceByPhoneService {
    @Override
    public QRY190424Result queryCurrentPriceByPhone(String billId) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "QRY190424";
        ...
        try {
            ...
            if (__ret instanceof QRY190424Result) {
                __result = (QRY190424Result) __ret;
            } else {
                __result = new QRY190424Result();
