...
public class QueryMyBaseInfoServiceClientImpl extends BaseClientServiceImpl implements IQueryMyBaseInfoService
{
	public QRY040099Result queryMyBaseInfo(String phoneNum,String startcycle) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040099";
		...
		try
		{
			...
			if(__ret instanceof QRY040099Result)
			{
				__result = (QRY040099Result)__ret;
			}
			else
			{
				__result = new QRY040099Result();
