...
import com.xwtech.xwecp.service.logic.pojo.QRY300013Result;

public class QueryEquityBusinessDataServiceImpl extends BaseClientServiceImpl implements IQueryEquityBusinessDataService {
    @Override
    public QRY300013Result queryEquityBusinessData(Object publics,Object busiInfo) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "QRY300013";
        XWECPLIClient __client = XWECPLIClient.getInstance();
        ServiceMessage __msg = __client.getMsgHelper().createRequestMessage(__cmd);
        RequestData __requestData = new RequestData();
        RequestParameter __param_publics= new RequestParameter("public", publics);
        __requestData.getParams().add(__param_publics);
        ...
        try {
            ...
            if (__ret instanceof QRY300013Result) {
                __result = (QRY300013Result) __ret;
            } else {
                __result = new QRY300013Result();
