...
public class QueryPointsDueServiceImpl extends BaseClientServiceImpl implements IQueryPointsDueService {
    @Override
    public QRY180527Result queryPointsDue(String svcNum) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "QRY180527";
        ...
        try {
            ...
            if (__ret instanceof QRY180527Result) {
                __result = (QRY180527Result) __ret;
            } else {
                __result = new QRY180527Result();
