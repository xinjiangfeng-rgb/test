...
import com.xwtech.xwecp.service.logic.client_impl.common.ISaveTaxpayerIdentificationCodeService;
import com.xwtech.xwecp.service.logic.pojo.QRY170804Result;

public class SaveTaxpayerIdentificationCodeServiceImpl extends BaseClientServiceImpl implements ISaveTaxpayerIdentificationCodeService {

    @Override
    public QRY170804Result saveTaxpayerIdentificationCode(String billId, String ghfNsrmc, String ghfNsrsbh, String ghfDz, String ghfDhhm, String ghfkhh, String ghfYhzh) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "QRY170804";
        ...
        RequestParameter __param_ghfkhh = new RequestParameter("ghfkhh", ghfkhh);
        __requestData.getParams().add(__param_ghfkhh);
        ...
        try {
            ...
            if (__ret instanceof QRY170804Result) {
                __result = (QRY170804Result) __ret;
            } else {
                __result = new QRY170804Result();
