...
public class SearchUserUnlimitSpeedLimitedServiceImpl extends BaseClientServiceImpl implements ISearchUserUnlimitSpeedLimitedService {


    @Override
    public QRY199412Result searchUserUnlimitSpeedLimited(String phoneNum) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "QRY199412";
        ...
        try
        {
            ...
            if(__ret instanceof QRY199412Result)
            {
                __result = (QRY199412Result)__ret;
            }
            else
            {
                __result = new QRY199412Result();
