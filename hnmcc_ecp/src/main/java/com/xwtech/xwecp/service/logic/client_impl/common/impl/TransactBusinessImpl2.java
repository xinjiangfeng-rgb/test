 ...
 */
public class TransactBusinessImpl2 implements ITransactBusiness2 {

    @Override
    public QRY930020Result transactBusiness2(String phoneNum, String bossCode, String OperMode, String Optrld) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "QRY930020";
        ...
        try {
            ...
            if (__ret instanceof QRY930020Result) {
                __result = (QRY930020Result) __ret;
            } else {
                __result = new QRY930020Result();
