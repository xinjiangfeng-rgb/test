 ...
 * 查询用户订购国际业务到期时间及状态
 */
public class QryIntelBusStateServiceImpl extends BaseClientServiceImpl implements IQryIntelBusStateService {

	@Override
	public QRY200272Result queryIntelBusState(String phoneNum)throws LIException {
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY200272";
		...
		try
		{
			...
			if(__ret instanceof QRY200272Result)
			{
				__result = (QRY200272Result)__ret;
			}
			else
			{
				__result = new QRY200272Result();
