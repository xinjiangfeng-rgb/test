...
public class QueryUserCreditClientImpl extends BaseClientServiceImpl implements IQueryUserCreditService
{
	public QRY040101Result queryUserCredit(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040101";
		...
		try
		{
			...
			if(__ret instanceof QRY040101Result)
			{
				__result = (QRY040101Result)__ret;
			}
			else
			{
				__result = new QRY040101Result();
