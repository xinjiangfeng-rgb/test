...
public class QRY201512Result extends BaseServiceInvocationResult implements Serializable {
    ...
    private List<ExpireDateCodeName> marketings;//宽带营销活动及到期时间
    ...
    public List<ExpireDateCodeName> getMarketings() {
        return marketings;
    }

    public void setMarketings(List<ExpireDateCodeName> marketings) {
