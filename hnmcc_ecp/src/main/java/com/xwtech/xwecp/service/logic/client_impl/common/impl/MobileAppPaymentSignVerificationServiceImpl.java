...
public class MobileAppPaymentSignVerificationServiceImpl extends BaseClientServiceImpl implements IMobileAppPaymentSignVerificationService {
    ...
    public PAY181116Result mobileAppPaymentSignVerification( String payment,String orderMoney, String gift, String merActivityID, String paymentType, String paymentLimit, String productID, String productName, String productDesc, String productURL, String productType, String returnURL, String clientIP, String customParam, String buyerID, String iDType, String iDValue, String defaultBank, String authCode, String reqChannel, String busiType, String requestFromUrl, String logonID, String contractCode, String signValidityPeriod, String oriReqDate, String timeoutExpress, String activityCode) throws LIException {
        ...
        try {
            ...
            if (__ret instanceof PAY181116Result) {
                __result = (PAY181116Result) __ret;
            } else {
                __result = new PAY181116Result();
