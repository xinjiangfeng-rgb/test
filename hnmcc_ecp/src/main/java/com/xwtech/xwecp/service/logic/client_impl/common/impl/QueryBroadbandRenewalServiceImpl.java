...
public class QueryBroadbandRenewalServiceImpl extends BaseClientServiceImpl implements IQueryBroadbandRenewalService {
    @Override
    public QRY191119Result queryBroadbandRenewal(String billId) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "QRY191119";
        ...
        try {
            ...
            if (__ret instanceof QRY191119Result) {
                __result = (QRY191119Result) __ret;
            } else {
                __result = new QRY191119Result();
