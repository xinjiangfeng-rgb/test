...
public class ChangesAddedProductTcServiceImpl extends BaseClientServiceImpl implements IChangesAddedProductTcService {
    @Override
    public DEL980013Result changesAddedProductTc(String svcNum, String operMode, String prodCustomParaType, String addProdPrcId, String prodPrcPara, String optrId, String telephonist) throws LIException {
        ...
        try {
            ...
            if (__ret instanceof DEL980013Result) {
                __result = (DEL980013Result) __ret;
            } else {
                __result = new DEL980013Result();
