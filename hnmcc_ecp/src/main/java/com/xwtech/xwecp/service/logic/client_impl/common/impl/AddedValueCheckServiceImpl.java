...
public class AddedValueCheckServiceImpl extends BaseClientServiceImpl implements IAddedValueCheckService {


    @Override
    public DEL200604Result addedValueCheck(String SvcNum, String OfferId, String FiltMarket) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "DEL200604";
        ...
        try {
            ...
            if (__ret instanceof DEL200604Result) {
                __result = (DEL200604Result) __ret;
            } else {
                __result = new DEL200604Result();
