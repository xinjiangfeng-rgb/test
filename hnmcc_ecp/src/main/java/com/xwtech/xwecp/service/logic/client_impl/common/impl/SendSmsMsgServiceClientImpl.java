...
{
	public QRY080001Result sendSmsMsg(String mobile, String content, String optCode, String sendPort) throws LIException
	{
		...
		RequestParameter __param_sendPort = new RequestParameter("sendPort", sendPort);
		__requestData.getParams().add(__param_sendPort);
