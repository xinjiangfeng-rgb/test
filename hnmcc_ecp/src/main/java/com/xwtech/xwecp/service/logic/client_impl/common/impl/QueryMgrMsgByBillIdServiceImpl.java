...
public class QueryMgrMsgByBillIdServiceImpl extends BaseClientServiceImpl implements IQueryMgrMsgByBillIdService {
    @Override
    public QRY912116Result queryMgrMsgByBillId(String billId) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "QRY912116";
        ...
        try {
            ...
            if (__ret instanceof QRY912116Result) {
                __result = (QRY912116Result) __ret;
            } else {
                __result = new QRY912116Result();
