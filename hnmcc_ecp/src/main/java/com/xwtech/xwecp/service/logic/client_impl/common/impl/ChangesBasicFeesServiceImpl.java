...
public class ChangesBasicFeesServiceImpl extends BaseClientServiceImpl implements IChangesBasicFeesService {
    @Override
    public DEL930049Result changeBaseFee(String svcNum, String instanceId, String mainProdPrcParaValue, String mainProdPrcCustParaType, String optrId, String telephonist) throws LIException {
        ...
        try {
            ...
            if (__ret instanceof DEL930049Result) {
                __result = (DEL930049Result) __ret;
            } else {
                __result = new DEL930049Result();
