...
public class CheckPasswordServiceClientImpl extends BaseClientServiceImpl implements ICheckPasswordService
{
	public QRY040003Result checkPassword(String phoneNum, String password) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040003";
		...
		try
		{
			...
			if(__ret instanceof QRY040003Result)
			{
				__result = (QRY040003Result)__ret;
			}
			else
			{
				__result = new QRY040003Result();
