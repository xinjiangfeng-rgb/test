...
public class QueryCurrentDayFeeServiceClientImpl extends BaseClientServiceImpl implements IQueryCurrentDayFeeService
{
	public QRY010097Result queryCurrentDayFee(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY010097";
		...
		try
		{
			...
			if(__ret instanceof QRY010097Result)
			{
				__result = (QRY010097Result)__ret;
			}
			else
			{
				__result = new QRY010097Result();
