...
public class QueryMGroupInfoClientImpl extends BaseClientServiceImpl implements IQueryMGroupInfoService
{
	public QRY040097Result queryMGroupInfo(String phoneNum) throws LIException
	{
		long __beginTime = System.currentTimeMillis();
		String __cmd = "QRY040097";
		...
		try
		{
			...
			if(__ret instanceof QRY040097Result)
			{
				__result = (QRY040097Result)__ret;
			}
			else
			{
				__result = new QRY040097Result();
