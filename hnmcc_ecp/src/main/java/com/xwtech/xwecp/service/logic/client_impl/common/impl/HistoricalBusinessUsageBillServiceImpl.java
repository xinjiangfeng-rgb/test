...
public class HistoricalBusinessUsageBillServiceImpl extends BaseClientServiceImpl implements IHistoricalBusinessUsageBillService {
    @Override
    public QRY420035Result historicalBusinessUsageBill(String billId, String billingCycleId) throws LIException {
        long __beginTime = System.currentTimeMillis();
        String __cmd = "QRY420035";
        ...
        try {
            ...
            if (__ret instanceof QRY420035Result) {
                __result = (QRY420035Result) __ret;
            } else {
                __result = new QRY420035Result();
