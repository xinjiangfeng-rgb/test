...
//				public void run()
//				{
//					if ( FlowContrlUtil.checkCurrConnNums("cmd", Thread.currentThread().getName(), channel1, 5) )
//					{
//						try
//						{
//							Thread.sleep(500);
...
//							e.printStackTrace();
//						}
//						FlowContrlUtil.removeCurrConn("cmd", Thread.currentThread().getName(), channel1);
//					}
//					else
//					{
...
//				public void run()
//				{
//					if ( FlowContrlUtil.checkCurrConnNums("cmd", Thread.currentThread().getName(), channel2, 5) )
//					{
//						try
//						{
//							Thread.sleep(500);
...
//							e.printStackTrace();
//						}
//						FlowContrlUtil.removeCurrConn("cmd", Thread.currentThread().getName(), channel2);
//					}
//					else
//					{
