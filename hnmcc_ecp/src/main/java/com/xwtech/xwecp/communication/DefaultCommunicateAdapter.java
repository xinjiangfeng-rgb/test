...
{
    private static final Logger logger = LoggerFactory.getLogger(DefaultCommunicateAdapter.class);
...
//        {
//            String boss = dispatchMap.get(id);
//            communicator = communicatorMap.get(boss);
//        }
        
//        logger.info("********* findCommunicatorForRequest **************" + (this.communicator == null));
        
        return this.communicator;
    }
    
//    @SuppressWarnings("unchecked")
//    public ICommunicator findCommunicatorForRequest2(Object request)
//    {
//
//        ICommunicator communicator = null;
//        String process_code = "";
...
//                    // if (StringUtils.isNotBlank(channelId) && StringUtils.isNotBlank(process_code) &&
//                    // StringUtils.isNotBlank(sysfunc_id))
//                    // {
//                    // Map<String, String> configMap = teletextDispatchDAO.getChannelTeletextConfig(channelId,
//                    // process_code, sysfunc_id);
...
//                        {
//                            boss = "boss001";
//                            showLog(process_code, "抢流量红包BOSS接口ECP平台转发 一库", "boss001", "");
//                        }
//                        // BOSS负载均衡地址 二库
//                        else if (BOSSCITYS_TWO.toString().indexOf(usercity) != -1)
//                        {
//                            boss = "boss002";
//                            showLog(process_code, "抢流量红包BOSS接口ECP平台转发 二库", "boss002", "");
//                        }
//                        // BOSS负载均衡地址 三库
//                        else if (BOSSCITYS_THREE.toString().indexOf(usercity) != -1)
//                        {
//                            boss = "boss003";
//                            showLog(process_code, "抢流量红包BOSS接口ECP平台转发 三库", "boss003", "");
//                        }
//                        // BOSS负载均衡地址 四库
//                        else if (BOSSCITYS_FOUR.toString().indexOf(usercity) != -1)
//                        {
//                            boss = "boss004";
//                            showLog(process_code, "抢流量红包BOSS接口ECP平台转发 四库", "boss004", "");
//                        }
...
//            }
//            // 切换CRM紧急环境
//            Map<String, String> urgentDispatchMap = teletextDispatchDAO.getUrgentDispatchMap(msg.getContext()
//                .getUserCity());
...
//        {
//            NumberSegment ns = searchByHalf(XWECPWebApp.NUMBERSEGMENTS.get(phoneNumber.substring(0, 3)),
//                0,
//                XWECPWebApp.NUMBERSEGMENTS.get(phoneNumber.substring(0, 3)).size() - 1,
...
//    private NumberSegment searchByHalf(List<NumberSegment> list, int startSegment, int endSegment, String numSegment)
//    {
