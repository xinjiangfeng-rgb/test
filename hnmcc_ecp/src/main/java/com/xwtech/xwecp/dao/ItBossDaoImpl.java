...
//		List<CombineBean> ls = JSON.parseArray(this.getCache().get(key), CombineBean.class);
//		if(ls == null) {
...
//				Object[] args = new Object[(bossCode.length)+1];
...
//				this.getCache().add(key, JSON.toJSONString(ls));
//
//			}catch (Exception e) {
//				e.printStackTrace();
//			}
