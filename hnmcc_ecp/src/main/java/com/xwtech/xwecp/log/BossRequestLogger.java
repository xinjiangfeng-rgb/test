...
//{
//	private static final Logger logger = LoggerFactory.getLogger(BossRequestLogger.class);
//
//	private static final Logger bossRequestFailLogger = LoggerFactory.getLogger("bossRequestFailLogger");
//
...
//		lb.f_response_time =  getDateStr(endTime);
...
//		sb.append(log.f_req_text == null ? "" : log.f_req_text).append(COLUMN_SEPARATOR);
//		sb.append(log.f_res_text == null ? "" : log.f_res_text).append(COLUMN_SEPARATOR);
