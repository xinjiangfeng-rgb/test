...
public class RandomString {
	...
	public static String createRandom(){
		Date now = new Date();
        String hhmmsssss = String.format("%1$tH%1$tM%1$tS%1$tL", now);
		StringBuffer sb = new StringBuffer(hhmmsssss);
        return sb.append(RandomString.generateRandomString(7)).toString();
	}
...
//	}
	...
	public static void main(String[] args) {
		System.out.println(RandomString.createRandom());
	}
}
