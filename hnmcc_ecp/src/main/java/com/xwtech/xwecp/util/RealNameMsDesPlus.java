...
//？？？？？？？？？？？？XXXXXXXXXXX  整合平台配置平台和整合平台后台服务不能使用改加密方式， 编译环境是1.5， 这个加密方式需要jdk1.6的sunjcr_prodiver.jar
...
public class RealNameMsDesPlus {
	...
	public static void main (String[] args) throws Exception {
		RealNameMsDesPlus desPlus = new RealNameMsDesPlus("!tg%exu");
...
//		System.out.println(desPlus.decrypt("dfe58fbdb66709d20c1836ad4daa774d"));
		System.out.println(desPlus.encrypt("测试"));
		System.out.println(desPlus.encrypt("423121199908160525"));
	}
}